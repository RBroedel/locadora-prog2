                    ...
                    do {
                        ...
                        items.forEach(item -> {
                            if (item.getId() == idCompra) {
                                ...
                                System.out.println("O LIVRO foi comprado ou está fora de estoque!");
                            }
                        });
                    ...
                    do {
                        ...
                        items.forEach(item -> {
                            if (item.getId() == idCompra) {
                                ...
                                System.out.println("O DVD foi comprado ou está fora de estoque!");
                            }
                        });
                    ...
                    do {
                        ...
                        items.forEach(item -> {
                            if (item.getId() == idCompra) {
                                ...
                                System.out.println("O REVISTA foi comprado ou está fora de estoque!");
                            }
                        });
